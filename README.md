# Shree Harsha's Academic Portfolio

This repository hosts the static GitHub Pages site for Shree Harsha:

<https://shreeharsha-bs.github.io/>

The site is intentionally lightweight: plain HTML and CSS, no build step, and no
JavaScript required.
